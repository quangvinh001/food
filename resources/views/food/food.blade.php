	...
	<div class="product-item">
        <div class="product-img">
            <a href="{{route('foods.show', [$f->id])}}">
               <img width="260" height="260" src="/images/{{$f->image}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="{{$f->name}}" srcset="/images/{{$f->image}}" sizes="100vw" />            </a>
        </div>
            ...
            <div class="product-title">
            	<a href="{{route('foods.show', [$f->id])}}">{{ $f->name }}</a>
                        ...
                        <div class="product-price clearfix">
            	                	<span class="current-price"><span class="woocommerce-Price-amount amount">{{ $f->sale_price }}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                	<span class="original-price"><s><span class="woocommerce-Price-amount amount">{{ $f->price }}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
                			</div>
...
@foreach ($food as $f)
	...
	<div class="product-item">
        <div class="product-img">
            <a href="{{route('foods.show', [$f->id])}}">
               <img width="260" height="260" src="/images/{{$f->image}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="NHO XANH" srcset="/images/{{$f->image}}" sizes="100vw" />            </a>
        </div>
        <div class="product-info">
            <div class="product-title">
            	<a href="{{route('foods.show', [$f->id])}}">{{ $f->name }}</a>
